    ...
    <div className="trend-container container">
      ...
      <section className="trends-grid">
        <div className="trend-item">
          <img src="images/p-1.jpeg" alt="Trending Item 1" className="trend-image" />
        ...
        <div className="trend-item">
          <img src="images/p-10.jpeg" alt="Trending Item 2" className="trend-image" />
          <div className="trend-content">
        ...
        <div className="trend-item">
          <img src="images/p-11.jpeg" alt="Trending Item 3" className="trend-image" />
          <div className="trend-content">
            <h3>Fitness Gear</h3>
